...
export class GBuilder {
    ...
    constructor(builder?: BuildFunction | ExternalBuilder) {
        if (is.Function(builder))
            this.customBuildFunc = builder as BuildFunction;
        else if (is.Object(builder) && builder!.hasOwnProperty('command'))
            this.externalBuilder = Object.assign({}, builder) as ExternalBuilder;
    }
    ...
    build(): void | Promise<this | void> {
        if (this.externalBuilder) {
            return GPlugin.exec(this,
                this.externalBuilder.command,
                this.externalBuilder.args,
                this.externalBuilder.options
