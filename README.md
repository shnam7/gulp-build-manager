...
Following are common options. Please refer the the example or template files generated by 'gbm init' for the details.
- enableLint: enable linter if available.
- enablePlumber: enable [plumber](https://github.com/floatdrop/gulp-plumber)
- enableChanged: enable [changed](https://github.com/sindresorhus/gulp-changed)
- enableBabel: enable [babel](https://github.com/babel/gulp-babel) for GJavaScriptBuilder
- postcss: [postcss](https://github.com/postcss/gulp-postcss) plugins in the form of { plugins:{ require('postcss-cssnext') } }
- tsConfig: Set path name for 'tsconfig.json' file. Specific to GTypeScriptBuilder.
