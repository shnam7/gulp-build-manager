...
rtb_1.RTB.registerExtension('css', (options = {}) => (rtb) => {
    ...
    if (opts.autoPrefixer === undefined && opts.autoPrefixer !== undefined) {
        ...
        utils_1.warn('[GBM:ext.css] DeprecationWarning: buildOptions.autoPrefixer is deprecated. Use buildOptions.autoprefixer.');
    }
    if (mopts.autoPrefixer === undefined && opts.autoPrefixer !== undefined) {
        mopts.autoprefixer = mopts.autoPrefixer;
        utils_1.warn('[GBM:ext.css] DeprecationWarning: moduleOptions.autoPrefixer is deprecated. Use moduleOptions.autoprefixer.');
    }
    // basic build options
