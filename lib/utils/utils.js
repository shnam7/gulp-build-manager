...
exports.dmsg = dmsg;
function msg(...args) { console.log(...args); }
exports.msg = msg;
function info(...args) { console.log(chalk.green(...args)); }
exports.info = info;
function notice(...args) { console.log(chalk.yellow(...args)); }
exports.notice = notice;
function warn(...args) { console.log(chalk.redBright(...args)); }
exports.warn = warn;
